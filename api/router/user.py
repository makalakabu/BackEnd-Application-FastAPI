...
from service.follow import follow_user, unfollow_user, list_of_followers, list_of_following, create_follow_request, list_of_follow_request, accept_follow_request, delete_follow_request
...
def follow_username(
    ...
    try:
        if target.is_private:
            create_follow_request(db=db, user_id=current_user.id, target_id=target.id)
        else:   
